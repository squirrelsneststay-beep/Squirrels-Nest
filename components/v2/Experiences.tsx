...
const MOMENTS: Moment[] = [
  {
    key: "courtyard",
    title: "The courtyard",
    body: "Step outside into your private enclosed courtyard, complete with outdoor seating — ideal for morning coffee, alfresco dining, or unwinding under the stars.",
    img: "/images/squirrels-nest/sq-08.jpg",
    alt: "The private courtyard with its bistro table",
  },
  {
    key: "nature",
    title: "Woodland & wildlife",
    body: "Wake to stunning woodland views and the gentle sounds of nature, with horses, chickens, ducks and friendly cats and dogs adding to the idyllic setting.",
  ...
  {
    key: "explore",
    title: "Explore Berkshire",
    body: "A peaceful base to relax, recharge and explore the beauty of Berkshire, with open countryside and the North Wessex Downs all around.",
  ...
  },
  {
    ...
    body: "A charming shepherd's hut on site, with extra room for two — perfect for friends or family travelling together.",
